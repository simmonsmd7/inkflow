...
const navItems: NavItem[] = [
  ...
  },
  {
    ...
    href: '/no-show-tracking',
    roles: ['owner'],
  },
  {
    id: 'popular-time-slots',
    label: 'Popular Time Slots',
    icon: (
      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" />
      </svg>
    ),
    href: '/popular-time-slots',
    roles: ['owner'],
  },
  {
    id: 'consent',
  ...
  return (
    ...
    >
      ...
      <div className="h-16 flex items-center justify-between px-4 border-b border-ink-700">
        ...
        {collapsed && (
          <Link to="/dashboard" className="w-8 h-8 mx-auto bg-accent-primary rounded-lg flex items-center justify-center">
            <svg className="w-5 h-5 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" />
            </svg>
          </Link>
