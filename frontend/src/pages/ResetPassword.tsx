    ...
    <div className="min-h-screen bg-ink-900 flex items-center justify-center p-4">
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-xl font-semibold text-ink-100">Set new password</h1>
        ...
        <div className="bg-ink-800 rounded-xl border border-ink-700 p-6">
          {success ? (
            <div className="text-center">
              ...
              <Link
                to="/login"
                className="inline-flex items-center justify-center w-full py-2.5 px-4 rounded-lg font-medium text-white bg-accent-primary hover:bg-accent-primary/90 transition-all"
              >
                Sign in now
              </Link>
            </div>
